...
![High Level Design](./images/serverless-arch.png)
...
1. Click the arrow on "Test" and click "Configure test events"
...
![create DynamoDB table](./images/create-table.jpg)
...
2. To execute our API from local machine, we are going to use Postman and Curl command. You can choose either method based on your convenience and familiarity. 
    ...
    * To run this from terminal using Curl, run the below
    ...
    ```   
3. To validate that the item is indeed inserted into DynamoDB table, go to Dynamo console, select "lambda-apigateway" table, select "Explore table items" tab, and the newly inserted item should be displayed.
